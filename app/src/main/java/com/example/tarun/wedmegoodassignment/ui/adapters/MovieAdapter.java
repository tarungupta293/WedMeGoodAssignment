...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MyViewHolder> {
    ...
    private List<MovieResponse.Result> moviesList;
    private OnRecyclerItemClickListener onRecyclerItemClickListener;
    private boolean isFromFavourite;

    public MovieAdapter(Context context, List<MovieResponse.Result> moviesList,boolean isFromFavourite, OnRecyclerItemClickListener onRecyclerItemClickListener){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.txtTitle.setText(moviesList.get(position).getOriginalTitle());
        if (!isFromFavourite) {
            holder.imgFavourite.setVisibility(View.VISIBLE);
            if (moviesList.get(position).isFavouriteSelected())
